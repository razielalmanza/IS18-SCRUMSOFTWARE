...
@XmlRootElement
@NamedQueries( { @NamedQuery(name = "Usuario.findAll", query = "SELECT l FROM Usuario l WHERE l.administrador = :administrador" ),
                 @NamedQuery(name = "Usuario.findById", query = "SELECT l FROM Usuario l WHERE l.idUsuario = :idUsuario" ),
